...
plot1=plot_model(mod, colors="bw", show.values=TRUE, title= "Juncais", axis.title ="", vline.color= "red")
plot1 <- plot1 + theme(axis.title.y = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank())

plot2=plot_model(mod, colors="bw", show.values=TRUE, title= "Sangradouros", axis.title ="",vline.color= "red")
